...
TEST(Solver, Simple) {
    ...
    TGameState state_simple(std::vector{ToCards({0, 1, 2, 3, 4, 5, 6, 7, 8}),
    ...
    TGameState state_hopeless(std::vector{
            ToCards({0, 1, 2, 3, 4, 5, 6, 7, 8}),
            ToCards({0, 1, 2, 3, 4, 5, 6, 7, 8}),
            ToCards({0, 1, 2, 3, 4, 5, 6, 7, 8}),
            ToCards({0, 1, 2, 3, 4, 5, 6, 7, 8}),
...
TEST(Solver, SevenStackOneEmpty) {
    TGameState state_hard(std::vector{ToCards({8, 7, 6, 5, 4, 3, 2, 1, 0}),
